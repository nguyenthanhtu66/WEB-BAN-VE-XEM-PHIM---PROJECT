...
<div id="app" class="app">
    ...
    <div class="header-label">
        <div class="header-container">
            ...
            <div class="header-account">
                <a href="ticket-warehouse.jsp" class="header-item">Kho vé</a>
                <a href="Khuyen-mai.jsp" class="header-item">Khuyến mãi</a>
                <a href="gio-hang.jsp" class="header-item">
                    Giỏ hàng
        ...
        <div class="menu-container">
            ...
            <nav class="menu-nav">
                <div class="menu-item-wrapper">
                    <a href="index.jsp" class="menu-item">TRANG CHỦ</a>
                </div>

                <div class="menu-item-wrapper">
                    <div class="menu-item has-dropdown">PHIM</div>
                    <div class="dropdown-menu">
                        <a href="Phim-Dang-Chieu.jsp" class="dropdown-item">Phim đang chiếu</a>
                        <a href="Phim-Sap-Chieu.jsp" class="dropdown-item">Phim sắp chiếu</a>
                    </div>
                </div>
                ...
                <div class="menu-item-wrapper">
                    ...
                    <div class="dropdown-menu">
                        <a href="Tin-dien-anh.jsp" class="dropdown-item">Tin điện ảnh</a>
                        <a href="Binh-luan-phim.jsp" class="dropdown-item">Bình luận phim</a>

                    </div>
                </div>

                <div class="menu-item-wrapper">
                    <a class="menu-item" style="text-decoration: none;" href="Gia-Ve.jsp">GIÁ VÉ</a>
                </div>

                <div class="menu-item-wrapper">
                    <a class="menu-item" style="text-decoration: none;" href="Gioi-Thieu.jsp">GIỚI THIỆU</a>
                </div>
                <div class="menu-item-wrapper">
                    <a class="menu-item" style="text-decoration: none; color: #ff6600;" href="contact.jsp">LIÊN HỆ</a>
                </div>
            </nav>
        </div>
    </div>
    <div class="content">
        ...
        <div class="infomation">
            <div class="avatar">
                <img style="object-fit: cover; margin: 0px; width: 100%; height: 100%;"
                     src="img/anh-rap-phim.jpg"
                     alt="">
            </div>

            <div class="text">
                Bạn có nhu cầu quảng cáo trên màn hình cực lớn tại rạp, tiếp cận đông đảo khách xem phim tại rạp <br>
                ...
                Bạn cần một địa điểm tổ chức sự kiện, họp báo ra mắt dự án, tổ chức fan offline, đào tạo tập trung <br>
        ...
        <section class="form-section">
            ...
            <form class="contact-form" action="/xu-ly-lien-he" method="post">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="so-dien-thoai" name="soDienThoai" placeholder="Nhập Điện Thoại"
                               required>
                    </div>
                ...
                <div class="form-check full-width">
                    <input type="checkbox" id="dong-y" name="dy" required>
        ...
        <div style="margin: 40px 0px 40px;">
            ...
            <div class="description">
                ...
                <div class="service-description">
                    <h4>Mua Vé Nhóm:</h4>
                    <p>Càng đông càng vui! Tận hưởng mức giá ưu đãi đặc biệt khi đặt vé số lượng lớn cho công ty,
    ...
    <div class="footer">
        <div class="footer-top">
            <ul class="footer-menu">
                <li><a href="Chinh-sach.jsp">Chính sách</a></li>
                <li><a href="Phim-Sap-Chieu.jsp">Phim đang chiếu</a></li>
                <li><a href="Phim-Dang-Chieu.jsp">Phim sắp chiếu</a></li>
                <li><a href="Tin-dien-anh.jsp">Tin tức</a></li>
